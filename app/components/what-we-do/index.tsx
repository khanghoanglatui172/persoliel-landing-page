...
const dataCards = [
  {
    ...
    content: [
      "Meet curbside with boarding pass",
      "Secure porter for luggage assistance",
      "Expedite check in",
      "Fast track through security",
      "Escort to lounge, fulfill special requests",
      "Escort to gate for on-time boarding",
    ],
  },
  {
    id: 2,
    ...
    content: [
      "Meet at arrival gate",
      "Escort to lounge",
      "Fulfill special requests",
      "Escort to gate for boarding",
    ],
  },
  {
    id: 3,
    ...
    content: [
      ...
      "Secure porter for luggage assistance",
      "Coordinate with chauffeur",
      "Escort to waiting car and driver",
      "Assist with tracking delayed luggage",
    ],
  },
];
...
function Card({ card }: any) {
  return (
    <div className="block min-h-[28.6rem] bg-white dark:bg-white border border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="mt-12">
        <div className="px-5">
          <h4 className="text-center text-3xl font-normal leading-loose">
            {card.title}
          </h4>
          <div>
            <ul>
                ...
                card.content.map((text: string, index: number) => {
                  return (
                    <li key={index} className="h-[2.5rem] overflow-hidden flex">
                      ...
                      <p className="text-app-dark text-[1rem] font-normal leading-[0.9rem]">
                        {text}
                      </p>
                    </li>
                  );
      ...
      <div className="mb-20">
        ...
        <div className="text-center w-[57rem] mb-14 m-auto">
          <span className="text-neutral-700 text-[21px] leading-[29.40px]">
            Indulge in the comfort of an effortless journey through the
            terminal, leaving the details to us. Our priority is to ensure
            you’re able to focus on what matters most to you.
          </span>
        </div>
        <div className="w-2/3 m-auto flex justify-center">
          <Link
            href="/booking/index.html"
            className="w-[302px] h-[73px] relative"
          >
            ...
            <div className="w-[290.41px] h-[26px] left-[5.79px] top-[21.45px] absolute text-center text-amber-50 text-[18.99px] font-bold uppercase">
              BOOK YOUR SERVICE
            </div>
          </Link>
        </div>

...
function OurPromise() {
    return (
        <div className={`bg-[url('/backgrounds/background-contourmap1-simplifiedtravel.svg')] pt-[7.19rem] bg-center bg-no-repeat`}>
            <div>
            ...
            <div className='m-auto w-5/6'>
                <div className='mt-16 text-center text-app-amber text-xl font-medium flex justify-center'>
                    <span className='leading-3'>
                        Watch the video
                    </span>
                    <Image src='/icons/icon-play.svg' alt='icon-play' width={17} height={17} className='ms-2'/>
                </div>

        ...
        <div className='nav-bar'>
            <div className='w-5/6 h-16 m-auto flex items-center relative'>
                <div className="w-[149px] h-[139.69px] relative flex-grow-0">
                    <div className="w-[inherit] h-[inherit] top-[27%] absolute" style={{zIndex:3}}>
                        ...
                        {headers.map((header, index) => {
                            return (
                                <li key={index} className='px-5'>
                                    <Link href={header.scrollTo} scroll={true} className='text-right text-[1.0625rem]  not-italic font-medium text-slate-600'>
                                        {header.name}
                                    </Link>
                                </li>
                            )
                ...
                <div className='nav-bar-right flex-grow-0'>
                    <div className='flex justify-between items-center'>
                        <Link href={''} className='text-amber-800 flex items-center'>
                            <span className='text-right text-[1.0625rem] not-italic font-medium me-3'>Sign in</span>
                            <Image src='/icon-signin-arrow.svg' alt='arrow-signin' width={14} height={0} className='pt-0.5'/>
                        </Link>
                    </div>
                </div>
            </div>

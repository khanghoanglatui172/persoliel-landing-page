...
function Banner() {
    return (
        <div className='app-banner'>
            ...
            <div className='w-5/6 absolute top-[35%] left-[8%]'>
                <div className='banner-title text-slate-600 text-[3.6rem] not-italic !font-thin leading-[3.9rem] mb-10'>Enjoy a friction-free<br/>journey between<br/>car and cabin seat. </div>

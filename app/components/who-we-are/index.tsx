...
function WhoWeAre() {
    return (
        <div className={`bg-[url('/who-we-are-bg.png')] bg-no-repeat bg-who-we-are-percentage bg-cover w-[100%] h-[46rem] relative`}>
            ...
            <div className='absolute w-[33rem] h-[100%] top-[47%] left-[8%] z-[2] text-amber-50'>

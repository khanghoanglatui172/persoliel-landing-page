...
(function(a, b, c) {
  ...
  var d = function(a, b, c) {
      ...
      var f,
        g,
        h = e.runValidations(a, b, c);
      for (f in h)
        for (g in h[f])
          if (e.isPromise(h[f][g]))
            throw new Error(
  ...
  (e.extend = function(a) {
    ...
    e.extend(d, {
        ...
        for (d in b) {
          ...
          for (f in h) {
            if (((i = e.validators[f]), !i))
              throw ((k = e.format("Unknown validator %{name}", { name: f })),
              new Error(k));
            (j = h[f]),
      ...
      isDomElement: function(a) {
        return a && a.querySelectorAll && a.querySelector
      ...
      getDeepObjectValue: function(a, b) {
        return e.isObject(a)
          ? e.forEachKeyInKeypath(a, b, function(a, b) {
      ...
      collectFormValues: function(a, b) {
          ...
          (f = g.item(c)),
            e.isDefined(f.getAttribute("data-ignored")) ||
              ...
              "number" === f.type
                ...
                : "checkbox" === f.type
                ? f.attributes.value
                  ? f.checked || (i = j[f.name] || null)
                  : (i = f.checked)
                : "radio" === f.type && (f.checked || (i = j[f.name] || null)),
              (j[f.name] = i));
        for (g = a.querySelectorAll("select[name]"), c = 0; c < g.length; ++c) {
          if (((f = g.item(c)), f.multiple)) {
            ...
            for (d in f.options)
              (h = f.options[d]),
                h.selected && i.push(e.sanitizeFormValue(h.value, b));
          ...
          a.forEach(function(a) {
            ...
            return e.isString(d)
              ? ("^" === d[0]
                  ? (d = d.slice(1))
                  : b.fullMessages !== !1 &&
                    (d = e.capitalize(e.prettify(a.attribute)) + " " + d),
                (d = d.replace(/\\\^/g, "^")),
                (d = e.format(d, { value: e.stringifyValue(a.value) })),
                void c.push(e.extend({}, a, { error: d })))
              : void c.push(a);
          }),
          c
        );
    ...
    (d.validators = {
      presence: function(a, b) {
        return (
          ...
          ? !e.isDefined(a)
          : e.isEmpty(a))
            ? b.message || this.message || "can't be blank"
            : void 0
        );
      },
          ...
          for (c in g)
            if (((d = b[c]), e.isNumber(d) && !g[c](a, d))) {
              var i = "not" + e.capitalize(c),
                j =
                  b[i] || this[i] || this.message || "must be %{type} %{count}";
              f.push(e.format(j, { count: d, type: e.prettify(c) }));
            }
          return (
            b.odd &&
              a % 2 !== 1 &&
              f.push(b.notOdd || this.notOdd || this.message || "must be odd"),
            b.even &&
              a % 2 !== 0 &&
              f.push(
                b.notEven || this.notEven || this.message || "must be even"
              ),
            f.length ? b.message || f : void 0
          );
        }
      },
      datetime: e.extend(
      ...
      equality: function(a, b, c, d) {
        if (e.isDefined(a)) {
          ...
          return h(a, g, b, c, d)
            ? void 0
            : e.format(f, { attribute: e.prettify(b.attribute) });
        }
      },
      url: function(a, b) {
        if (e.isDefined(a)) {
